...
class HelloControllerTest {
    ...
    public void hello() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .get("http://localhost:8080/api/hello/tt")
                .param("name", "涛涛"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string("Hellott"))
                .andExpect(MockMvcResultMatchers.header().string("Content-Type", "text/plain;charset=ISO-8859-1"))
                .andExpect(MockMvcResultMatchers.header().string("Content-Length", "7"))
